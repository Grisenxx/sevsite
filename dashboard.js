...
function getTurnstileResponse(containerId) {
    ...
    const turnstileElement = container.querySelector('.cf-turnstile');
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    document.getElementById('login-form').addEventListener('submit', async (e) => {
        ...
        const turnstileToken = getTurnstileResponse('login-container');
        
        if (!turnstileToken) {
            showError('error-message', 'Please complete the verification.');
            return;
        }
    ...
    document.getElementById('register-form').addEventListener('submit', async (e) => {
        ...
        const turnstileToken = getTurnstileResponse('register-container');
        
        if (!turnstileToken) {
            showError('register-error-message', 'Please complete the verification.');
            return;
        }
