...
const features = [
  ...
  },
  {
    icon: ShieldOff,
    title: "Full Unban",
    description: "Complete HWID spoofer and unban solution included with every plan. Get back in instantly."
  },
  {
    icon: Cpu,
            ...
            >
              ...
              <div className="relative z-10">
                <div className="w-10 h-10 rounded-xl bg-violet-500/10 flex items-center justify-center mb-5">
                  <feature.icon className="w-5 h-5 text-violet-400" strokeWidth={1.5} />
                </div>
